...
async function main() {
                ...
                create: [
                    ...
                    },
                    {
                        ...
                        data: [
                            {
                                title: 'Product 1',
                                imageUrl: 'https://pangee-siecwauy.xyz/img/product1.6fba4f66.png',
                            },
                            {
                                title: 'Product 1',
                                imageUrl: 'https://pangee-siecwauy.xyz/img/product2.4f625484.png',
                            },
                            {
                                title: 'Product 1',
                                imageUrl: 'https://pangee-siecwauy.xyz/img/product3.3653ca04.png',
                            },
                        ],
                    },
                    {
                ...
                create: [
                    ...
                    },
                    {
                        ...
                        data: [
                            ...
                            {
                                title: 'Product 5',
                                imageUrl: 'https://pangee-siecwauy.xyz/img/product5.322b0f1b.png',
                            },
                            {
                                title: 'Product 6',
                                imageUrl: 'https://pangee-siecwauy.xyz/img/product6.f333f6a0.png',
                            },
                        ],
                    },
                    {
                ...
                create: [
                    {
                        ...
                        content: "Pharrell's appointment signals a new era for LV, blending music and high fashion to attract a younger audience.",
                        usagesCount: 120,
                    },
                ],
            },
    ...
    const createdCampaings = await Promise.all(compaingsData.sort((a, b) => a.order - b.order).map((camp) => prisma.comapaings.create({
        data: {
            id: camp.id,
            title: camp.title,
    ...
    const createdCampaingItems = await Promise.all([
        ...campaingItemsNames.map((name, index) => prisma.comapaingItems.create({
            data: {
                title: name,
                image: imageUrls[index % imageUrls.length],
                type: [
                    campaingItemTypes[Math.floor(Math.random() * campaingItemTypes.length)],
                ],
            },
        })),
        ...randomPDFLinks.map((pdfUrl, i) => prisma.comapaingItems.create({
            data: {
                title: `Document ${i + 1}`,
                image: pdfUrl,
                type: ['Documents'],
    ...
    async function createCategoryWithChildren(parentTitle, childTitles) {
    ...
    console.log('Child Categories created:', readyToWear.children.length +
