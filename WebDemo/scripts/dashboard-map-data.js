...
const locationData = {
  ...
  hotels: [
    ...
    { lat: 40.7241, lng: -74.0003, name: 'The Mercer Hotel', address: '147 Mercer St', image: 'assets/soho/hotels/the-mercer.png', keywords: ['The Mercer', 'SoHo', 'luxury hotel', 'Sartiano'] }
  ],
  museums: [
